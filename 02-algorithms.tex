...
\todo[inline]{better search keys, text...}
\begin{sidewaysfigure}
    \centering
    \subbottom[Binárne vyhľadávanie] {
        \resizebox{\textwidth}{!}{
            \input{figures/search_comparison/height9_find202_binsearch}
        }
    }
    \subbottom[Strom v \emph{BFS} usporiadaní] {
        \resizebox{\textwidth}{!}{
            \input{figures/search_comparison/height9_find202_bfstree}
        }
    }
    \subbottom[Strom vo \vEB usporiadaní] {
        \resizebox{\textwidth}{!}{
            \input{figures/search_comparison/height9_find202_vebtree}
        }
    }
    \caption{Porovnávanie prístupov ku pamäti v rôznych štruktúrach pri vyhľadávaní hodnoty $202$}
