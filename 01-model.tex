...
%            \multicolumn{1}{c}{\textbf{Názov}} & \multicolumn{3}{c}{\textbf{Operácie}} & \\ \toprule
            \textbf{Vyhľadávacie stromy} & \textbf{Vyhľadávanie} & \textbf{Vkľadanie} & \textbf{Prechod}\tnote{1} & \\ \toprule
            ...
            \obliv B-strom & $\bigO{\log_B{N}}$ & $\bigO{\log_B{N}}$ \amort & & \citep{btreeshort,btreefull,bender2002}, časť \ref{sec:dynamic-obliv-improved} \\ 
            \toprule
