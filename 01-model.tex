...
\begin{table}
    \centering
    \caption{Približné parametre rôznych úrovní pamäte. Hodnoty troch úrovní \cache na procesore (L1, L2 a L3) sú pre mikroarchitektúru Intel Haswell. \citep{inteloptimize,inteldeveloper}}
