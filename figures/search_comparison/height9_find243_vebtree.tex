...
\draw [color=darkgray, fill = yellow!40!white] (1.0, 0.0) rectangle (1.25, -0.25);
...
\draw [color=darkgray, fill = green] (0.0, -0.75) rectangle (0.25, -1.0)node [midway] (A2) {};
...
\draw [color=darkgray, fill = green] (0.75, -0.75) rectangle (1.0, -1.0)node [midway] (A4) {};
...
\draw [color=darkgray, fill = red!60!white] (15.0, -0.25) rectangle (15.25, -0.5)node [midway] (A5) {};
\draw [color=darkgray, fill = green] (15.0, -0.5) rectangle (15.25, -0.75)node [midway] (A6) {};
\draw [color=darkgray, fill = green] (15.25, 0.0) rectangle (15.5, -0.25)node [midway] (A7) {};
\draw [color=darkgray, fill = white] (15.25, -0.25) rectangle (15.5, -0.5);
\draw [color=darkgray, fill = red!60!white] (15.25, -0.5) rectangle (15.5, -0.75)node (LAST) [midway, draw, circle, inner sep = 0, outer sep=2.5, minimum size=2, fill=black] {};
\draw [color=darkgray, fill = yellow!40!white] (15.25, -0.75) rectangle (15.5, -1.0);
...
\draw [color=darkgray, fill = yellow!40!white] (15.0, -0.75) rectangle (15.25, -1.0);
