...
\draw [color=darkgray, fill = red!60!white] (0.75, -0.75) rectangle (1.0, -1.0)node [midway] (A0) {};
\draw [color=darkgray, fill = green] (1.0, 0.0) rectangle (1.25, -0.25)node (LAST) [midway] {};
\draw [color=darkgray, fill = green] (1.0, -0.25) rectangle (1.25, -0.5)node [midway] (A3) {};
\draw [color=darkgray, fill = yellow!40!white] (1.0, -0.5) rectangle (1.25, -0.75);
\draw [color=darkgray, fill = red!60!white] (1.0, -0.75) rectangle (1.25, -1.0)node [midway] (A2) {};
...
\draw [color=darkgray, fill = red!60!white] (1.25, -0.75) rectangle (1.5, -1.0)node [midway] (A1) {};
